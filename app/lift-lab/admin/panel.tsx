  ...
  return (
    <section className="lift-lab-admin lift-suite">
      ...
      {tab === "calendar" ? <div className="lift-suite__stack">
        ...
        {trainer ? <div className="lift-lab-admin-grid"><section className="lift-lab-card"><h2>Open availability</h2><p className="lift-lab-card__intro">Open one date or repeat the same time weekly. The normal booking window is 14 days, but you can open dates as far ahead as you choose.</p><form className="lift-lab-form" onSubmit={createAvailability}><label>Starts<input name="startsAt" type="datetime-local" required /></label><label>Ends<input name="endsAt" type="datetime-local" required /></label><label>Repeat weekly<input name="repeatWeeks" type="number" min="1" max="52" defaultValue="1" /></label><label>Private note<input name="note" /></label><button className="button">Open Time</button></form></section><section className="lift-lab-card"><h2>Mark time off</h2><p className="lift-lab-card__intro">Save a full day off or block only part of a day. Any open times that overlap are automatically blocked.</p><form className="lift-lab-form" onSubmit={createTimeOff}><label>Date<input name="offDate" type="date" required /></label><label className="lift-lab-disclaimer"><input name="fullDay" type="checkbox" /><span><strong>Entire day off</strong><small>Leave the times below blank.</small></span></label><div className="lift-lab-form-row"><label>From <span>(for partial day)</span><input name="offStart" type="time" /></label><label>Until <span>(for partial day)</span><input name="offEnd" type="time" /></label></div><label>Private note <span>(optional)</span><input name="offNote" placeholder="Appointment, vacation, unavailable…" /></label><button className="button button--outline">Save Time Off</button></form></section></div> : null}
