...
type Tab = "overview" | "calendar" | "clients" | "services" | "programs" | "payments" | "settings" | "customer preview" | "madie preview";
...
export default function LiftLabAdmin() {
  ...
  const tabs: Tab[] = trainer ? ["overview", "calendar", "clients", "services", "programs", "payments", "settings"] : ["overview", "calendar", "clients", "customer preview", "madie preview"];
